...
{
    public partial class FormReplanishWarehouse : Form
    {
        private int id;

        public FormReplanishWarehouse(int id)
        {
            InitializeComponent();
            this.id = id;
        }

        private void FormReplanishWarehouse_Load(object sender, System.EventArgs e)
        {
            try
            {

...
namespace ReinforcedConcreteFactoryFileImplement.Implements
{
    public class ProductLogic : IProductLogic
    {
        ...
        {
            Product element = source.Products
            ...
            source.ProductComponents.RemoveAll(rec => rec.ProductId == model.Id && !model.ProductComponents.ContainsKey(rec.ComponentId));

            var updateComponents = 
                source.ProductComponents.Where(rec => rec.ProductId == model.Id && model.ProductComponents.ContainsKey(rec.ComponentId));
